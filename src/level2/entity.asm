...
lungeState:
	jsr level2_zip_mover_lunge_move
...
retreatState:
	jsr level2_zip_mover_retreat_move
...
drawProcess:
	...
	jmp level2_tall_zip_mover_draw
...
.proc level2_zip_mover_lunge_move
	lda temp4
	pha
	lda temp3
	pha
...
.proc level2_zip_mover_retreat_move
	lda temp4
	pha
	lda temp3
	pha
...
dontPrepare:
	jsr level2_zip_mover_lunge_move::moveXY
	
	jmp level2_zip_mover_lunge_move::epilogue
.endproc

.proc level2_tall_zip_mover_draw
idle    = level2_zip_mover::idle
charge  = level2_zip_mover::charge
lunge   = level2_zip_mover::lunge
crash   = level2_zip_mover::crash
retreat = level2_zip_mover::retreat
cooldn  = level2_zip_mover::cooldn

	; What the level2_zip_mover routine did before:
	...
	lda #0
	sta temp10
	jsr level2_zip_mover::skipLeftSpriteIfNeeded
	lda temp10
loop:
	sta temp10
...
noAnim:
	...
	jmp level2_zip_mover::spikeyProcessing
